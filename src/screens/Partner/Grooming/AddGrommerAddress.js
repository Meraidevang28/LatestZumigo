...
// const AddGrommerAddress = ({navigation}) => {
//   return (
...
//           onPress={() => navigation.navigate(screens.GroomerAddressDetails)}>
...
// export default AddGrommerAddress;
import {View, Text, ScrollView, TouchableOpacity, Image} from 'react-native';
import React from 'react';
import images from '../../../assets/images';
import screens from '../../../constants/screens';
  ...
  return (
    <View className="flex-1 bg-white px-6">
      ...
      <ScrollView
        ...
        <TouchableOpacity
          className=" flex-row w-full justify-center items-center bg-white border-2 border-primary  rounded-full py-2 gap-2"
          onPress={() => navigation.navigate(screens.MapViewScreenGroomer)}>
          <Text className="text-[30px]  text-primary">+</Text>
          <Text className=" font-Nunito-Bold text-[21px] text-primary">
            Add Address
          </Text>

...
const AddMedicationSummaryScreen = () => {
    ...
    <>
        ...
        <View className="flex-1">
          ...
          <View>
            <TouchableOpacity
              ...
              <View className=" flex flex-row items-center justify-between  h-[58px] bg-pastelGrey border border-pastelgreyBorder rounded-[15px]  ">
                <View className="flex-row justify-center items-center  gap-[12.7px] ml-[17px] ">
      ...
      <View
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate(screens.InProgressHomeVisit4)}>
...
export default AddMedicationSummaryScreen;

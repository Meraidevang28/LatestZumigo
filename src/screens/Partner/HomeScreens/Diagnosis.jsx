    ...
    <>
          ...
          <View className="flex-1">
            <ScrollView>
              <View className=" bg-pastelGrey border border-pastelgreyBorder rounded-2xl ">
                <View className="flex flex-row items-center  pl-[10px]  ">
                  <Image
                  ...
                  <TextInput
                    ...
                    className="ml-[12px] text-[#000000]"></TextInput>
                </View>
              </View>
      ...
      <BottomSheetModal
        ...
        <BottomSheetView>
          ...
          <View className="  px-6 ">
            <TouchableOpacity
              className="bg-primary items-center justify-center h-[56px] rounded-2xl mb-[20px]"
              onPress={() => {

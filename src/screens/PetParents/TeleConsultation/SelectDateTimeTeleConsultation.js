...
const SelectDateTimeTeleConsultation = ({navigation}) => {
  ...
  return (
    <View className="flex-1 bg-white px-6">
      ...
      <FooterBtn
        ...
        onClick={() => navigation.navigate(screens.PreviewTeleProceedPayment)}
      />
    </View>
  );
};

export default SelectDateTimeTeleConsultation;

...
//         body: JSON.stringify({
//           UserUUID: useruuid,
//           Master_Company_UUID: 'your-company-uuid',
//           Master_Environment_UUID: environmantUUID,
...
const AddYourPet = ({navigation, route}) => {
  ...
  //   'YourCustomFont-Bold': require('./assets/fonts/YourFont-Bold.ttf'),
  //   'YourCustomFont-Medium': require('./assets/fonts/YourFont-Medium.ttf'),
  // });
          ...
          >
            {selectedImage ? (
              <>
                ...
                <TouchableOpacity
                  onPress={() => setSelectedImage(null)}
                  className="absolute top-[-5] right-[-8] bg-primary px-2 py-1 rounded-full ">

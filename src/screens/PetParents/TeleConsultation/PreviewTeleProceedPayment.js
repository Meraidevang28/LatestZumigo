...
const PreviewTeleProceedPayment = ({navigation}) => {
  const petDetails = [
    {
      id: 1,
  ...
  const petServicesnapPoints = useMemo(() => ['50%'], []);
  ...
  const editBtnPressed = () => {
    navigation.navigate(screens.SelectDataTimeHomeVisit);
  };
      ...
      <BottomSheetModalProvider>
        <View className="flex-1 bg-white px-6">
          <ScrollView>
            ...
            <View className="bg-[#F2F6F733] border border-[#848A9A33] mt-5 rounded-2xl">
              <View className="flex flex-row px-3 py-5  gap-3">
                ...
                <View className="flex flex-col">
                  <Text className="text-[20px] font-PTSans-Bold">
                    Dr. Manisha
                  </Text>
                  <Text
              ...
              <View className="flex flex-row items-center gap-2 px-2 mb-3">
                <Image
            ...
            <View className="bg-[#F2F6F733] border border-[#848A9A33] rounded-[10px] h-20 mt-5 flex flex-row items-center justify-between px-1">
              <View className="flex flex-col">
                <View className="flex flex-row items-center">
                  <Image
                  ...
                  <TouchableOpacity className="border-2 border-primary items-center justify-center rounded-full px-2 py-1 ml-2">
                    <Text
                      className="text-primary font-Nunito-Regular text-[14px]"
                      style={{fontWeight: '700'}}>
                      Apply
                ...
                <View className="flex flex-row mt-1">
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      navigation.navigate(screens.TeleCouponsScreen);
                    }}>
        ...
        <BottomSheetView>
          <View className="p-3">
            ...
            <View className="bg-[#F2F6F733] border border-[#848A9A33] mt-4 rounded-[10px] px-3 py-3">
              ...
              <View className="w-full h-[0.8px] bg-[#848A9A33] mt-3"></View>
              <Text
...
export default PreviewTeleProceedPayment;

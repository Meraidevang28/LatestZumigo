  ...
  const handleSubmit = async () => {
    try {
      ...
      if (response.ok) {
        ...
        console.log('Address Stored in DB:', resData);
  ...
  return (
    <View className="flex-1 bg-white px-6">
      ...
      <FooterBtn
        ...
        //       );
        //       console.log('Address saved to local storage:', addressData); // Log the saved address
        //     } catch (e) {
        ...
        onClick={async () => {
          ...
          // 1. Save address to AsyncStorage
          try {
            await AsyncStorage.setItem(
              'saved_user_address',
              JSON.stringify(addressData),
            ...
            console.error('Failed to save address locally:', e);
          }

          // 2. Save address to backend
          try {
            const payload = {
              Master_Environment_UUID: '9549B2F6-0350-4484-9269-58F85A4FFxx1',
              UserType_uuid: userTypeUuid,

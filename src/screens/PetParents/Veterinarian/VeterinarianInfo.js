      ...
      <BottomSheetModalProvider>
        <View className="flex-1 px-6  bg-white">
          <ScrollView>
            ...
            {/* <View className="flex flex-row gap-[10px] pt-5">
              <Image
              ...
              <View>
                ...
                <Text className="text-[16px] text-[#838999] font-Nunito-Regular mb-[5px] opacity-50  ">
            ...
            <View className="flex flex-row gap-[10px] pt-5">
              ...
              <View className="flex-1">
                ...
                <View className="flex-row flex-wrap">
                  <Text className="text-[12px] font-normal text-gray-400 font-Nunito-Regular mr-1">
                    Known Languages:
                  </Text>
                  {['Telugu', 'Hindi', 'English'].map((lang, index) => (
                    <Text
                      key={index}
                      className="text-[12px] text-darkGunmetal font-Nunito-Regular mr-1">
                      {lang}
                      {index < 4 && ','}
                    </Text>
                  ))}

    ...
    <View className="flex-1 bg-white px-6">
      <ScrollView
        ...
        <View className=" mt-5 mb-[5.8px]">
          <View className="bg-pastelGrey border border-pastelgreyBorder mb-[15px] p-[13px] pt-[12px] rounded-2xl flex-row gap-2">
            <Image
              source={images.address}
              className="h-4 w-[13.21px]"
              resizeMode="contain"
            />
            <View>
              <Text
              ...
              <Text
                ...
                2nd Floor 205, Homeland Apartments 7th Street, Delhi 110041-
                Nangloi Chowk
              </Text>
            </View>
          </View>
        ...
        <View className="flex-row justify-between flex-1 gap-[8.5px] pb-40">
          {[
            {
              type: 'Home',
              image: images.Home,

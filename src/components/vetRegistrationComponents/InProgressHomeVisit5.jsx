    ...
    <>
      <BottomSheetModalProvider>
        <View className="flex-1 bg-white px-6">
            ...
            <View className="flex-1">
              ...
              <View>
                <View className=" bg-pastelGrey border border-pastelgreyBorder rounded-2xl mt-[15px]">
                  ...
                  <Text className="w-[314.5px] h-[0.5px] bg-[#bbbcb8] ml-[15px]  mb-[15px]"></Text>
                  <View className="flex flex-row  ml-[15.3px] justify-between">
                    <View className="flex flex-row items-center gap-[9.7px]">
                      <Image
                        source={require('../../assets/images/bandageIcon.png')}
                        style={{tintColor: primary}}
          ...
          {/* <FooterBtn title="Share to customer" onClick={openConfirmationSheet} /> */}
              ...
              <View className="flex bg-[white] px-6">
                <View className=" items-center flex flex-col ">
                  ...
                  <Text className="text-[20px]  font-Nunito-Regular text-[#000000] mt-[20px] ml-[29px]">
                    ...
                    selected services are updated and 'Close appointment' is
                    clicked
                  </Text>
                </View>
              </View>
...
export default InProgressHomeVisit5;
